		...
		<div class="h-screen pb-14 bg-right bg-cover" ">
			...
			<div class="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
				...
				<div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
					...
					<a href="student/login.php"><button class="bg-none hover:bg-blue-200 text-blue-600 font-bold py-2 px-4 rounded-full">
						Student
						</button></a>
				...
				<div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in ">
					...
					<a href="admin/login.php" class="inline-block text-sm px-4 py-2 leading-none text-purple-900 border-blue-600 hover:border-transparent hover:text-purple-300 hover:underline mt-4 lg:mt-0">Login As Admin?</a>
				</div>
			</div>
		</div>
	</body>
